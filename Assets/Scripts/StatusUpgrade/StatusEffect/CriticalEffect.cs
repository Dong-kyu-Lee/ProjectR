...
public class CriticalEffect : MonoBehaviour
{
    ...
    private void Awake()
    {
        statusEffectTooltip[0] = transform.Find("CriticalEffect1").GetComponent<StatusEffectTooltip>();
        statusEffectTooltip[1] = transform.Find("CriticalEffect4").GetComponent<StatusEffectTooltip>();
        statusEffectTooltip[2] = transform.Find("CriticalEffect7").GetComponent<StatusEffectTooltip>();
        statusEffectTooltip[3] = transform.Find("CriticalEffect10").GetComponent<StatusEffectTooltip>();
        statusEffectTooltip[4] = transform.Find("CriticalEffect13").GetComponent<StatusEffectTooltip>();
        statusEffectTooltip[5] = transform.Find("CriticalEffect16").GetComponent<StatusEffectTooltip>();
    }
