...
public class BlacksmithAbilityV2 : MonoBehaviour, IAbilityV2
{
    ...
    public void EnchantWeapon()
    {
        ...
        SoundManager.Instance.Play("Sounds/battle/WeaponEnhance", Sound.Blacksmith_Enhance, 1.5f);
    ...
    void TryUpgradeGrade()
    {
        ...
        if (roll <= chance)
        {
            ...
            SoundManager.Instance.Play("Sounds/battle/WeaponEnhance", Sound.Blacksmith_Enhance, 1.2f);
    ...
    void TryDestroyWeapon()
    {
        ...
        if (roll <= finalDestroyChance)
        {
            ...
            SoundManager.Instance.Play("Sounds/battle/WeaponDestroyed", Sound.Blacksmith_Enhance, 1.0f);
            Deactivate();
        }
        else
        {
            InGameUIManager.Instance.ShowStatus("등급 성장 실패... 장비 단계가 초기화되었습니다.");
            SoundManager.Instance.Play("Sounds/battle/WeaponDestroyed", Sound.Blacksmith_Enhance, 1.5f);
            curWeaponData.EnchantLevel = 0;
            enchantLevel = 0;
            RefreshWeaponBonus();
        }
